...
public class MHPQTest {
    ...
    public void addTest() {
        ...
        assertEquals(15, myHeap.getBackingArray()[2]);
        assertEquals(20, myHeap.getBackingArray()[3]);
        assertEquals(7, myHeap.getBackingArray()[4]);
        assertEquals(9, myHeap.getBackingArray()[5]);
        assertEquals(10, myHeap.getBackingArray()[6]);*/
        System.out.println(myHeap.getBackingArray()[1]);
        System.out.println(myHeap.getBackingArray()[2]);
        System.out.println(myHeap.getBackingArray()[3]);
        System.out.println(myHeap.getBackingArray()[4]);
        System.out.println(myHeap.getBackingArray()[5]);
        System.out.println(myHeap.getBackingArray()[6]);
    }
    @Test
